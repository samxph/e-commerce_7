...
<form action="/login/registration">
    ...
    <div class="form-group col-6">
        ...
        <input class="form-control" name="usermail" type="email" placeholder="Example@email.com" maxlength="30">
        ...
        <input class="form-control" name="userpostcode" placeholder="Enter Postcode" maxlength="5">
